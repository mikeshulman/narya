...
def eqvId (A0 : Type) (A1 : Type) (A2 : Id Type A0 A1) (B0 : Type)
    ...
    (a2 ↦
     eq.cat (A2 (g0 b0) (g1 b1))
       ...
       (eq.trr2 A0 A1 (x y ↦ A2 x y) (gfg0 b0) (g0 b0)
          ...
          (g2 (fg0 b0) (fg1 b1) (f2 (g0 b0) (g1 b1) a2))) a2
       ...
       (Id_eq A0 A1 A2 (gfg0 b0) (gfg1 b1)
          (g2 (fg0 b0) (fg1 b1) (f2 (g0 b0) (g1 b1) a2)) (g0 b0) (g1 b1) a2
          (ap_g0 (fg0 b0) b0 (ε0 b0)) (ap_g1 (fg1 b1) b1 (ε1 b1))
          (eq.trl2 (eq A0 (gfg0 b0) (g0 b0)) (eq A1 (gfg1 b1) (g1 b1))
             (u v ↦
              Id eq A0 A1 A2 (gfg0 b0) (gfg1 b1)
                (g2 (fg0 b0) (fg1 b1) (f2 (g0 b0) (g1 b1) a2)) (g0 b0)
                (g1 b1) a2 u v) (ap_g0 (fg0 b0) b0 (ε0 b0)) (η0 (g0 b0))
             (fro_to_fro A0 B0 e0 b0) (ap_g1 (fg1 b1) b1 (ε1 b1))
             (η1 (g1 b1)) (fro_to_fro A1 B1 e1 b1) (η2 (g0 b0) (g1 b1) a2))))
    (b2 ↦
