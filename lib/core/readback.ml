              ...
              Abwd.mapi
                (fun fld (Pbijmap.Wrap pbijflds) ->
                  ...
                  | Some (fldtm, l) ->
                      Pbijmap.Wrap
                        (Pbijmap.singleton
                           (readback_at ctx (force_eval_term fldtm) (tyof_field tm ty fld fldins), l))
            ...
            let fields =
              Abwd.mapi
                (fun fld _ ->
                  Pbijmap.Wrap
                    (Pbijmap.singleton
                       (readback_at ctx (field_term tm fld fldins) (tyof_field tm ty fld fldins), l)))
                fields in
                ...
                let fields =
                  Abwd.mapi
                    (fun fld _ ->
                      Pbijmap.Wrap
                        (Pbijmap.singleton
                           ( readback_at ctx (field_term tm fld fldins) (tyof_field tm ty fld fldins),
                             l )))
                    fields in
                Some (Struct (Eta, dim, fields, Kinetic))
            | _ -> None)
 ...
 fun ctx e ->
  ...
  | Vis { dim; plusdim; vars; bindings; hasfields; fields; fplus } ->
      ...
      let fields =
        Bwv.map
          (fun (f, x) ->
            let fldty = readback_val ctx (tyof_field top.tm top.ty f fins) in
            (f, x, fldty))
          fields in
